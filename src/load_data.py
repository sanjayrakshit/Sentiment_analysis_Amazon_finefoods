import pickle, numpy as np, pandas as pd, re, string, copy
...
class Load_data:
    def __init__(self, batch_size, sequence_length, min_word_freq):
        ...
        self.raw_data = self.raw_data.dropna().drop_duplicates(subset=['Summary', 'Text', 'Score'])
    ...
    def prepare_data(self):
        ...
        xpart_words = copy.deepcopy(xpart)
        xpart = [
        ...
        self.whole_data = list(zip(xpart_words, xpart, ypart))
